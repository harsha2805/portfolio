...
const ANIMATION_CONFIG = { SMOOTH_TAU: 0.25, MIN_COPIES: 3, COPY_HEADROOM: 4 };
...
export const LogoLoop = memo(
    ({
        ...
        const updateDimensions = useCallback(() => {
            ...
            const sequenceHeight = seqRef.current?.scrollHeight ?? 0;
            if (isVertical) {
                ...
                if (renderItem) {
                    return (
                        <li className="logoloop__item" key={key} role="listitem">
                            {renderItem(item, parseInt(key.split('-')[1]))}
                        </li>
                    );
                }
